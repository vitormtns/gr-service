...
public record HerdAnimalSummary(UUID id,String identification,String name,HerdAnimalSex sex,LocalDate birthDate,HerdAnimalStatus status,long version,PaddockSummary paddock) {
